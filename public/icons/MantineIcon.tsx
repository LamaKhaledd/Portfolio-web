  ...
  return (
    ...
    >
      <defs>
        ...
        M56.236 79.391a9.342 9.342 0 01.632-3.608 9.262 9.262 0 011.967-3.077 9.143 9.143 0 012.994-2.063 9.06 9.06 0 017.103 0 9.145 9.145 0 012.995 2.063 9.262 9.262 0 011.967 3.077 9.339 9.339 0 01-2.125 10.003 9.094 9.094 0 01-6.388 2.63 9.094 9.094 0 01-6.39-2.63 9.3 9.3 0 01-2.755-6.395z"
            fill="black"
            transform="scale(1.3,1.3) translate(-20,-20)"
          />
        </mask>
      </defs>

      <circle cx="80" cy="80" r="80" mask="url(#mask)" />
    </svg>
  );
};